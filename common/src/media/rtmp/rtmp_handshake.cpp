...
static const uint8_t g_GenuineFPKey[] = {0x47, 0x65, 0x6E, 0x75, 0x69, 0x6E, 0x65, 0x20, 0x41, 0x64, 0x6F, 0x62, 0x65,
...
// CalculateDigest
//===============================================================================================
void RtmpHandshake::CalculateDigest(int digest_pos, const uint8_t *message, uint8_t *key, int key_size,
                                    uint8_t *digest) {
