...
class RtmpImportChunk : public RtmpMuxUtil {
 public:
  ...
  void SetChunkSize(size_t chunk_size) { _chunk_size = chunk_size; }
 ...
 private:
  ...
  bool ProcessChunkHeader(const std::shared_ptr<RtmpChunkHeader> &chunk_header,
  ...
  std::shared_ptr<const RtmpMessage> FinalizeMessage(const std::shared_ptr<const RtmpChunkHeader> &chunk_header,
