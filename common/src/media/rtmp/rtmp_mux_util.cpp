...
int RtmpMuxUtil::GetChunkHeaderSize(RtmpChunkType chunk_type, uint32_t chunk_stream_id, int basic_header_size,
...
//====================================================================================================
std::shared_ptr<RtmpChunkHeader> RtmpMuxUtil::GetChunkHeader(void *raw_data, int raw_data_size, int &chunk_header_size,
                                                             bool &extend_type) {
  // auto *raw_data_pos = (uint8_t *)raw_data;
...
//====================================================================================================
int RtmpMuxUtil::GetChunkData(int chunk_size, void *raw_data, int raw_data_size, int chunk_data_size, void *chunk_data,
                              bool extend_type) {
  auto *raw_data_pos = (uint8_t *)raw_data;
...
int RtmpMuxUtil::GetChunkHeaderRaw(std::shared_ptr<RtmpChunkHeader> &chunk_header, void *raw_data, bool extend_type) {
  ...
  // basic_header 만들기
  basic_header_size =
      GetChunkBasicHeaderRaw(chunk_header->basic_header.format_type, chunk_header->basic_header.stream_id, raw_data);
...
// - RawData :     [Block] + [Type3 Header] + [Block] + [Type3 Header] + [Block] ..... 구조
//====================================================================================================
int RtmpMuxUtil::GetChunkDataRaw(int chunk_size, uint32_t chunk_stream_id,
