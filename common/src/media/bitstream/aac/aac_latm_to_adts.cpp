...
bool AACLatmToAdts::GetExtradata(const cmn::PacketType type, const std::shared_ptr<ov::Data> &data,
...
*/
bool AACLatmToAdts::Convert(const cmn::PacketType type, const std::shared_ptr<ov::Data> &data,
...
std::shared_ptr<ov::Data> AACLatmToAdts::MakeHeader(uint8_t aac_profile, uint8_t aac_sample_rate, uint8_t aac_channels,
                                                    int16_t data_length) {
