...
// 	if ( audioObjectType == 1 || audioObjectType == 2 || audioObjectType == 3 || audioObjectType == 4 || audioObjectType
// == 6 || audioObjectType == 7 ) 		GASpecificConfig(); 	if ( audioObjectType == 8 ) 		CelpSpecificConfig(); 	if (
// audioObjectType == 9 ) 		HvxcSpecificConfig(); 	if ( audioObjectType == 12 ) 		TTSSpecificConfig(); 	if ( audioObjectType
// == 13 || audioObjectType == 14 || audioObjectType == 15 || audioObjectType==16) 		StructuredAudioSpecificConfig(); 	if (
// audioObjectType == 17 || audioObjectType == 19 || audioObjectType == 20 || audioObjectType == 21 || audioObjectType
// == 22 || 		 audioObjectType == 23 ) 		GASpecificConfig(); 	if ( audioObjectType == 24) 		ErrorResilientCelpSpecificConfig();
// 	if ( audioObjectType == 25)
// 		ErrorResilientHvxcSpecificConfig();
// 	if ( audioObjectType == 26 || audioObjectType == 27)
// 		ParametricSpecificConfig();
// 	if ( audioObjectType == 17 || audioObjectType == 19 || audioObjectType == 20 || audioObjectType == 21 ||
// audioObjectType == 22 || 		 audioObjectType == 23 || audioObjectType == 24 || audioObjectType == 25 ||	audioObjectType
// == 26 || audioObjectType == 27 )
// 	{
// 		epConfig; 2 bslbf
...
// 		}
// 		If(AudioObjectType==17 || AudioObjectType == 18 || AudioObjectType == 19 || AudioObjectType == 20 ||
