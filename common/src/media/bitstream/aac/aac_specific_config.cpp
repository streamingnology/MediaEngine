...
AacObjectType AACSpecificConfig::ObjectType() { return _object_type; }

void AACSpecificConfig::SetOjbectType(AacObjectType object_type) { _object_type = object_type; }

AacSamplingFrequencies AACSpecificConfig::SamplingFrequency() { return _sampling_frequency_index; }
...
uint8_t AACSpecificConfig::Channel() { return _channel; }

void AACSpecificConfig::SetChannel(uint8_t channel) { _channel = channel; }
