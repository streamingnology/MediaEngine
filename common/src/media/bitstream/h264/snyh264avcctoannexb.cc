...
bool SnyH264AvccToAnnexB::GetExtradata(const cmn::PacketType type, const std::shared_ptr<ov::Data> &data,
...
bool SnyH264AvccToAnnexB::Convert(cmn::PacketType type, const std::shared_ptr<ov::Data> &data,
                                  const std::vector<uint8_t> &extradata, std::shared_ptr<ov::Data> &annexb_data) {
  annexb_data = std::make_shared<ov::Data>();
