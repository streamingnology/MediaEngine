...
bool FlvVideoData::Parse(const uint8_t *data, size_t data_length, FlvVideoData &video_data) {
  ...
  video_data._composition_time = parser.ReadBits<uint32_t>(24);
...
FlvVideoFrameTypes FlvVideoData::FrameType() { return _frame_type; }

FlvVideoCodecId FlvVideoData::CodecId() { return _codec_id; }

FlvAvcPacketType FlvVideoData::PacketType() { return _packet_type; }

uint32_t FlvVideoData::CompositionTime() { return _composition_time; }

const uint8_t *FlvVideoData::Payload() { return _payload; }
size_t FlvVideoData::PayloadLength() { return _payload_length; }
...
FlvSoundFormat FlvAudioData::Format() { return _format; }

FlvSoundRate FlvAudioData::SampleRate() { return _sample_rate; }

FlvSoundSize FlvAudioData::SampleSize() { return _sample_size; }

FlvSoundType FlvAudioData::Channel() { return _channel; }

FlvAACPacketType FlvAudioData::PacketType() { return _packet_type; }

const uint8_t *FlvAudioData::Payload() { return _payload; }

size_t FlvAudioData::PayloadLength() { return _payload_length; }