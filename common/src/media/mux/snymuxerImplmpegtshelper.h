...
const AP4_UI16 AP4_MPEG2_TS_DEFAULT_PID_VIDEO = 0x201;
...
class AP4_Mpeg2TsAudioSampleStream : public SampleStream {
 public:
  static AP4_Result Create(AP4_UI16 pid, AP4_UI32 timescale, AP4_UI08 stream_type, AP4_UI16 stream_id,
                           SampleStream*& stream, const AP4_UI08* descriptor, AP4_Size descriptor_length);
 ...
 private:
  AP4_Mpeg2TsAudioSampleStream(AP4_UI16 pid, AP4_UI32 timescale, AP4_UI08 stream_type, AP4_UI16 stream_id,
      ...
      : SampleStream(pid, stream_type, stream_id, timescale, descriptor, descriptor_length) {}
};

class AP4_Mpeg2TsVideoSampleStream : public SampleStream {
 public:
  static AP4_Result Create(AP4_UI16 pid, AP4_UI32 timescale, AP4_UI08 stream_type, AP4_UI16 stream_id,
                           SampleStream*& stream, const AP4_UI08* descriptor, AP4_Size descriptor_length);
  AP4_Result WriteSample(std::shared_ptr<SnyMediaSample> sample, AP4_SampleDescription* sample_description,
 ...
 private:
  AP4_Mpeg2TsVideoSampleStream(AP4_UI16 pid, AP4_UI32 timescale, AP4_UI08 stream_type, AP4_UI16 stream_id,
      ...
      : SampleStream(pid, stream_type, stream_id, timescale, descriptor, descriptor_size),
