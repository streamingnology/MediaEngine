...
:: cd uv-cpp-1.5.4\project\vs2017, in create_lib project, change dependent libuv's include and lib dir and name
:: build Debug and Release (x64)
:: run this script

set CURDIR=%CD%
set LIBUVCPP_DIR=%CURDIR%\uv-cpp-1.5.4
set INSTALL_DIR_DEBUG=%CURDIR%\..\build\uv-cpp\Debug
set INSTALL_DIR_RELEASE=%CURDIR%\..\build\uv-cpp\Release
