...
rem you can download compiled openssl from https://slproweb.com/products/Win32OpenSSL.html

call "C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Auxiliary\Build\vcvars64.bat"
set CURDIR=%CD%
cd %CURDIR%\openssl-OpenSSL_1_1_1d

set INSTALL_DIR_DEBUG=%CURDIR%\..\openssl\Debug
perl Configure --debug VC-WIN64A --prefix=%INSTALL_DIR_DEBUG%
nmake
nmake install

set INSTALL_DIR_RELEASE=%CURDIR%\..\openssl\Release
