...
MD %INSTALL_DIR_DEBUG%\include\C++
MD %INSTALL_DIR_DEBUG%\lib
MD %INSTALL_DIR_RELEASE%\include\C++
MD %INSTALL_DIR_RELEASE%\lib
XCOPY /Y /e /s %SOURCE_ROOT% %INSTALL_DIR_DEBUG%\include\C++
XCOPY /Y /e /s %SOURCE_ROOT% %INSTALL_DIR_RELEASE%\include\C++
